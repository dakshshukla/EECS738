# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 17:34:10 2019
...
X_all = np.load('images_flat.npy')
y_all = np.load('labels.npy')
X_all = X_all / 255

digits = 10
examples = y_all.shape[0]

y_all = y_all.reshape(1, examples)

Y_new = np.eye(digits)[y_all.astype('int32')]
Y_new = Y_new.T.reshape(digits, examples)

m = 60000
m_test = X_all.shape[0] - m

X_train, X_test = X_all[:m].T, X_all[m:].T
