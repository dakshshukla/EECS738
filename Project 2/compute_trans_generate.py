...
# runfile('compute_trans_generate.py', args = 'Shakesphere.txt 2000 5 5')
...
# Function for building/ creating a vocabulary of words
def build_vocab(file_name,num_lines):
    ...
    for ii in range(0,num_lines):
        ...
        num_words = len(words)
        if words[0] == 'act' or words[0] == 'scene' or words[0] == 'enter':
            continue
...
# Function for computing initial probabilities from the occurances
    # of starting words of each line, and also computing transition
    # probability matrix for each word in the vocabulary
